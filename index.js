        ...
        try {
            ...
            for (let num of participants) {
                ...
                try {
                    ...
                    ppuser = 'https://telegra.ph/file/f1061e1218860c277c50c.jpg'
                }
                ...
                try {
                    ...
                    ppgroup = 'https://telegra.ph/file/f1061e1218860c277c50c.jpg'
                }
...
naimi.sendMessage(anu.id, buttonMessage, {quoted:unicorndoc})
	...
	for (let i of kon) {
	    list.push({
	    	...
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await naimi.getName(i + '@s.whatsapp.net')}\nFN:${setting.ownerName}\nORG:${setting.deskripsi};\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Ponsel\nitem2.EMAIL;type=INTERNET:faruqofc@gmail.com\nitem2.X-ABLabel:Email\nitem3.URL:https://instagram.com/bokeptayo\nitem3.X-ABLabel:Instagram\nitem4.ADR:;;Japan;;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
